"""Phase 2 step 2 — ChildCase (child case) carries the new fields
and surfaces them on the API response shapes.

Covers the additive changes to:
  - api/store.py:ChildCase (5 new optional attributes)
  - api/store.py:ChildCase.to_summary / to_detail (pass-through)
