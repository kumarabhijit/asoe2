...
class TestGuardrail2_DynamicEnumServing:
    ...
    def test_health_serves_12_lifecycle_states(self, client):
        """architecture_v3.md §9.1 + Phase 3: 12 lifecycle states.
        EXECUTING removed with the /approve endpoint; PENDING_COSIGN
        remains for the four-eyes high-value override flow."""
        r = client.get("/api/v1/health")
